      ...
      <div className="container-hope">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          >
            ...
            <h3 className="font-serif text-charcoal text-2xl mb-3">Give Online</h3>
            ...
            <Link
              href="/give"
              className="inline-flex items-center justify-center gap-2 bg-charcoal text-white font-sans font-semibold text-sm tracking-wide uppercase px-7 py-3.5 w-full transition-all duration-200 hover:opacity-90 active:scale-95"
            >
              Give Now
            </Link>
          </motion.div>
